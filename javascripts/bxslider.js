...
;(function($j){
	...
	$j.fn.bxSlider = function(options){
		...
		if(this.length > 1){
			this.each(function(){$j(this).bxSlider(options)});
			return this;
		}
		...
		var updatePagerActive = function(slideIndex){
			...
			slider.pagerEl.each(function(i, el) { $j(el).find('a').eq(slideIndex).addClass('active'); });
		}
...
$j(document).ready(function () {
    $j('.home-banner-wrapper ul').bxSlider({
        auto: false,
        controls: false,
        adaptiveHeight:true
    });
